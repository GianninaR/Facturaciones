...
<?php
$id_sell = $sell->id; ?>
<form action="http://localhost/facturaciones/pdf/crearPdf.php" method="post">
	<input type="number" name="id" id="factura" value="<?=$id_sell?>" style="display:none">
	<input class="btn btn-success btn-lg" type="submit" value="Imprimir Factura">
</form>
<a href="pdf/crearPdf.php?id=<?=$id_sell?>" class="btn btn-success btn-lg">Imprimir Factura</a>
</div>
</div>
<?php else:?>
	501 Internal Error
