...
class PersonData {
	...
	public function add_client(){
		$sql = "insert into person (ruc,name,lastname,address1,email1,phone1,kind,created_at) ";
		$sql .= "value (\"$this->ruc\",\"$this->name\",\"$this->lastname\",\"$this->address1\",\"$this->email1\",\"$this->phone1\",1,$this->created_at)";
		Executor::doit($sql);
	}
...
// partiendo de que ya tenemos creado un objecto PersonData previamente utilizamos el contexto
	public function update(){
		$sql = "update ".self::$tablename." set ruc=\"$this->ruc\",name=\"$this->name\",email1=\"$this->email1\",address1=\"$this->address1\",lastname=\"$this->lastname\",phone1=\"$this->phone1\" where id=$this->id";
		Executor::doit($sql);
	}
